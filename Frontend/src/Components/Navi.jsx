  ...
  return (
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <div className="flex items-center gap-4">
        ...
        {!token && <div><a href="https://medicationadmin.vercel.app/"><button className="border border-primary text-primary px-4 py-2 rounded-full shadow-sm text-sm hover:bg-primary hover:text-white transition-all">Admin & Doctors Panel</button></a></div>}
